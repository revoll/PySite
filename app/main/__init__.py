...
utils_blueprint = Blueprint(u'utils', __name__, url_prefix=u'/utils')

from . import main_views, auth_views, blog_views, movie_views, music_views, photo_views, utils_views
